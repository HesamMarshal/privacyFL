...
# Simulation Parameters
# Dataset Options: KDDCUP, MNIST, SPINE, LIVING
DATASET = "SPINE"

# options:  Logistic, Neural, SVM
CLASSIFIER = 'Logistic'
...
#   Epsilons
epsilon = 0.01  # smaller epsilon --> more noise/less accuracy
...
# 50  # using equal size datasets for each client in this example
...
# LEN_TEST: Length of test dataset. Note whole dataset length is 1797 -> 300
# KDDCUP: 494020   - > 79000
LEN_TEST = 300
VERBOSITY = 1  # 1 to print out the result of each iteration
VERBOSE_DEBUG = 0  # 1 to print out the DEBUG DATA
F1_SCORE = False
"""Dataset Formatting"""
